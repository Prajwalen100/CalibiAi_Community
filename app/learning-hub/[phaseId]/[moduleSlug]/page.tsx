      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_16rem]">
        <article className="min-w-0">
          ...
          <nav className="mt-8 grid gap-3 sm:grid-cols-2">
            {lessonModule.prev ? (
              <Link
                href={`/learning-hub/${lessonModule.prev.phaseId}/${lessonModule.prev.slug}`}
            ...
            {lessonModule.next ? (
              <Link
                href={`/learning-hub/${lessonModule.next.phaseId}/${lessonModule.next.slug}`}
