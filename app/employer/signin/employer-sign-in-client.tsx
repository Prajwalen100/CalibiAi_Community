  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950/80 to-slate-950">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          className="absolute -top-40 left-1/4 h-[600px] w-[600px] rounded-full bg-gradient-to-tr from-indigo-500/20 via-brand-500/10 to-cyan-500/15 blur-[180px] animate-float-slow"
          style={{ animationDuration: "12s" }}
        />
        <div
          className="absolute top-1/3 right-0 h-[500px] w-[500px] rounded-full bg-gradient-to-br from-brand-500/10 via-indigo-500/10 to-purple-500/15 blur-[150px] animate-float-slow"
          style={{ animationDuration: "15s", animationDelay: "2s" }}
        />
        <div
          className="absolute -bottom-20 left-1/3 h-[400px] w-[400px] rounded-full bg-gradient-to-t from-brand-500/10 via-cyan-500/8 to-indigo-500/10 blur-[120px]"
        />
      </div>
      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-7xl gap-12 px-6 py-12 lg:grid-cols-2 lg:items-center lg:px-12">
        ...
        <ScrollReveal direction="left" className="hidden lg:block">
          ...
          <div className="mt-12 inline-flex items-center gap-2 rounded-full border border-indigo-400/30 bg-indigo-500/10 px-4 py-2 text-xs font-bold text-indigo-300 backdrop-blur-sm">
            <Sparkles className="h-3.5 w-3.5" />
            Employer workspace
          </div>

          <h1 className="mt-6 text-5xl font-black tracking-tight text-white leading-tight sm:text-6xl">
          ...
          <div className="mt-12 flex items-center gap-6">
            <p className="text-sm text-slate-400">
              ...
              <Link href="/signin?mode=sign-in" className="font-bold text-brand-400 hover:text-brand-300 transition-colors">
                Student login →
              </Link>
            </p>
          </div>
        ...
        <ScrollReveal direction="up" delay={150} className="flex flex-col items-center justify-center">
          ...
          <div className="mb-8 flex flex-col items-center gap-4 text-center lg:hidden">
            ...
            <div className="inline-flex items-center gap-2 rounded-full bg-indigo-500/15 border border-indigo-400/30 px-4 py-2 text-xs font-bold text-indigo-300">
          ...
          <div className="w-full max-w-md">
            <div className="relative rounded-3xl border border-white/10 bg-white/[0.07] p-8 shadow-2xl backdrop-blur-2xl">
              {/* Card inner glow */}
              <div className="pointer-events-none absolute inset-0 rounded-3xl bg-gradient-to-br from-white/[0.08] via-transparent to-indigo-500/[0.05]" />
