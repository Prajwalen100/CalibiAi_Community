...
export interface AuthComponentProps {
  ...
  mode?: AuthMode;
  /**
   * Called when the user submits email + password (and for sign-up, matched
   * confirm password). Return an error message to display an error modal.
   */
  ...
  /** Link href used when the user switches between sign-up and sign-in. */
  switchHref?: string;
}
...
export const AuthComponent = ({
  ...
  async function runEmailSubmit() {
    if (!onEmailSubmit) {
      // Demo mode: simulate onboarding steps and celebrate.
  ...
  return (
    <div className="bg-background min-h-screen w-full flex flex-col">
      <style>{`
        ...
        .glass-button-shadow::after { content: ""; position: absolute; inset: 0; border-radius: 9999px; background: linear-gradient(180deg, hsl(var(--foreground) / 20%), hsl(var(--foreground) / 10%)); width: calc(100% - var(--shadow-cutoff-fix) - 0.25em); height: calc(100% - var(--shadow-cutoff-fix) - 0.25em); top: calc(var(--shadow-cutoff-fix) - 0.5em); left: calc(var(--shadow-cutoff-fix) - 0.875em); padding: 0.125em; box-sizing: border-box; mask: linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0); mask-composite: exclude; transition: all var(--anim-time) var(--anim-ease); opacity: 1; }
        .glass-button { -webkit-tap-highlight-color: transparent; backdrop-filter: blur(clamp(1px, 0.125em, 4px)); transition: all var(--anim-time) var(--anim-ease); background: linear-gradient(-75deg, hsl(var(--background) / 5%), hsl(var(--background) / 20%), hsl(var(--background) / 5%)); box-shadow: inset 0 0.125em 0.125em hsl(var(--foreground) / 5%), inset 0 -0.125em 0.125em hsl(var(--background) / 50%), 0 0.25em 0.125em -0.125em hsl(var(--foreground) / 20%), 0 0 0.1em 0.25em inset hsl(var(--background) / 20%); }
        .glass-button:hover { transform: scale(0.975); backdrop-filter: blur(0.01em); box-shadow: inset 0 0.125em 0.125em hsl(var(--foreground) / 5%), inset 0 -0.125em 0.125em hsl(var(--background) / 50%), 0 0.15em 0.05em -0.1em hsl(var(--foreground) / 25%), 0 0 0.05em 0.1em inset hsl(var(--background) / 50%); }
        .glass-button-text { color: hsl(var(--foreground) / 90%); text-shadow: 0em 0.25em 0.05em hsl(var(--foreground) / 10%); transition: all var(--anim-time) var(--anim-ease); }
        .glass-button:hover .glass-button-text { text-shadow: 0.025em 0.025em 0.025em hsl(var(--foreground) / 12%); }
        .glass-button-text::after { content: ""; display: block; position: absolute; width: calc(100% - var(--border-width)); height: calc(100% - var(--border-width)); top: calc(0% + var(--border-width) / 2); left: calc(0% + var(--border-width) / 2); box-sizing: border-box; border-radius: 9999px; overflow: clip; background: linear-gradient(var(--angle-2), transparent 0%, hsl(var(--background) / 50%) 40% 50%, transparent 55%); z-index: 3; mix-blend-mode: screen; pointer-events: none; background-size: 200% 200%; background-position: 0% 50%; transition: background-position calc(var(--anim-time) * 1.25) var(--anim-ease), --angle-2 calc(var(--anim-time) * 1.25) var(--anim-ease); }
        ...
        .glass-button::after { content: ""; position: absolute; z-index: 1; inset: 0; border-radius: 9999px; width: calc(100% + var(--border-width)); height: calc(100% + var(--border-width)); top: calc(0% - var(--border-width) / 2); left: calc(0% - var(--border-width) / 2); padding: var(--border-width); box-sizing: border-box; background: conic-gradient(from var(--angle-1) at 50% 50%, hsl(var(--foreground) / 50%) 0%, transparent 5% 40%, hsl(var(--foreground) / 50%) 50%, transparent 60% 95%, hsl(var(--foreground) / 50%) 100%), linear-gradient(180deg, hsl(var(--background) / 50%), hsl(var(--background) / 50%)); mask: linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0); mask-composite: exclude; transition: all var(--anim-time) var(--anim-ease), --angle-1 500ms ease; box-shadow: inset 0 0 0 calc(var(--border-width) / 2) hsl(var(--background) / 50%); pointer-events: none; }
        ...
        .glass-button-wrap:has(.glass-button:active) .glass-button-text { text-shadow: 0.025em 0.25em 0.05em hsl(var(--foreground) / 12%); }

        .glass-input-wrap { position: relative; z-index: 2; transform-style: preserve-3d; border-radius: 9999px; }
        .glass-input { display: flex; position: relative; width: 100%; align-items: center; gap: 0.5rem; border-radius: 9999px; padding: 0.25rem; -webkit-tap-highlight-color: transparent; backdrop-filter: blur(clamp(1px, 0.125em, 4px)); transition: all 400ms cubic-bezier(0.25, 1, 0.5, 1); background: linear-gradient(-75deg, hsl(var(--background) / 5%), hsl(var(--background) / 20%), hsl(var(--background) / 5%)); box-shadow: inset 0 0.125em 0.125em hsl(var(--foreground) / 5%), inset 0 -0.125em 0.125em hsl(var(--background) / 50%), 0 0.25em 0.125em -0.125em hsl(var(--foreground) / 20%), 0 0 0.1em 0.25em inset hsl(var(--background) / 20%); }
        .glass-input-wrap:focus-within .glass-input { backdrop-filter: blur(0.01em); box-shadow: inset 0 0.125em 0.125em hsl(var(--foreground) / 5%), inset 0 -0.125em 0.125em hsl(var(--background) / 50%), 0 0.15em 0.05em -0.1em hsl(var(--foreground) / 25%), 0 0 0.05em 0.1em inset hsl(var(--background) / 50%); }
        .glass-input::after { content: ""; position: absolute; z-index: 1; inset: 0; border-radius: 9999px; width: calc(100% + clamp(1px, 0.0625em, 4px)); height: calc(100% + clamp(1px, 0.0625em, 4px)); top: calc(0% - clamp(1px, 0.0625em, 4px) / 2); left: calc(0% - clamp(1px, 0.0625em, 4px) / 2); padding: clamp(1px, 0.0625em, 4px); box-sizing: border-box; background: conic-gradient(from var(--angle-1) at 50% 50%, hsl(var(--foreground) / 50%) 0%, transparent 5% 40%, hsl(var(--foreground) / 50%) 50%, transparent 60% 95%, hsl(var(--foreground) / 50%) 100%), linear-gradient(180deg, hsl(var(--background) / 50%), hsl(var(--background) / 50%)); mask: linear-gradient(#000 0 0) content-box, linear-gradient(#000 0 0); mask-composite: exclude; transition: all 400ms cubic-bezier(0.25, 1, 0.5, 1), --angle-1 500ms ease; box-shadow: inset 0 0 0 calc(clamp(1px, 0.0625em, 4px) / 2) hsl(var(--background) / 50%); pointer-events: none; }
        ...
        .glass-input-text-area::after { content: ""; display: block; position: absolute; width: calc(100% - clamp(1px, 0.0625em, 4px)); height: calc(100% - clamp(1px, 0.0625em, 4px)); top: calc(0% + clamp(1px, 0.0625em, 4px) / 2); left: calc(0% + clamp(1px, 0.0625em, 4px) / 2); box-sizing: border-box; border-radius: 9999px; overflow: clip; background: linear-gradient(var(--angle-2), transparent 0%, hsl(var(--background) / 50%) 40% 50%, transparent 55%); z-index: 3; mix-blend-mode: screen; pointer-events: none; background-size: 200% 200%; background-position: 0% 50%; transition: background-position calc(400ms * 1.25) cubic-bezier(0.25, 1, 0.5, 1), --angle-2 calc(400ms * 1.25) cubic-bezier(0.25, 1, 0.5, 1); }
        ...
        >
          <AnimatePresence mode="wait">
            ...
            {authStep === "password" && (
              ...
              >
                ...
                <BlurFade delay={0.25}>
                  <p className="text-sm font-medium text-muted-foreground">{titles.passwordHint}</p>
                </BlurFade>
              </motion.div>
            )}
            {authStep === "confirmPassword" && isSignUp && (
              ...
              >
                ...
                <BlurFade delay={0.25}>
                  <p className="text-sm font-medium text-muted-foreground">{titles.confirmHint}</p>
                </BlurFade>
              </motion.div>
            )}
          </AnimatePresence>
          ...
          {switchHref && (
            <p className="text-sm text-muted-foreground">
              ...
              <a href={switchHref} className="font-semibold text-foreground hover:underline">
