...
const steps = [
  {
    ...
    iconBg: "bg-blue-50 text-blue-700 dark:bg-blue-500/15 dark:text-blue-400",
    glowColor: "blue",
  },
  {
    step: "02",
    ...
    iconBg: "bg-purple-50 text-purple-700 dark:bg-purple-500/15 dark:text-purple-400",
    glowColor: "purple",
  },
  {
    step: "03",
    ...
    iconBg: "bg-emerald-50 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-400",
    glowColor: "emerald",
  },
];
          ...
          {steps.map((item, index) => (
            ...
            >
              ...
              <div className="mb-6 flex items-center justify-between">
                <span className="text-5xl font-black text-slate-900/10 transition-colors group-hover:text-slate-900/20 dark:text-white/5 dark:group-hover:text-white/10">
                  {item.step}
                </span>
                <div
                  className={`flex h-14 w-14 items-center justify-center rounded-2xl ${item.iconBg} border border-slate-200/80 shadow-lg transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3 dark:border-white/10`}
                >
              ...
              <p className="text-sm font-bold text-slate-500 dark:text-white/40 mb-4">
                {item.subtitle}
              </p>
              ...
              {/* Arrow indicator */}
              <div className="mt-6 flex items-center gap-2 text-xs font-bold text-slate-500 transition-colors group-hover:text-slate-700 dark:text-white/30 dark:group-hover:text-white/60">
                <span>
